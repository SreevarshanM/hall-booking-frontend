                ...
                <div class="w-full bg-white rounded-lg shadow-xl dark:border md:mt-0 sm:max-w-md xl:p-0">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            <div>
                                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Applicant name</label>
                                <input type="email" name="email" id="email" class="bg-neutral-100 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full h-10  p-2.5" placeholder="Enter your name" required="" />
                            </div>
                            <div>
                            ...
                            <div class="flex items-center justify-center">
                                <p class="text-sm font-light text-gray-500">
                                    Already have an account? <a href="#" class="font-medium text-sky-500 hover:underline">Login</a>
                                </p>
                            </div>
                            <button type="submit" class="w-full text-white bg-sky-500 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-sm text-sm px-5 py-2.5 text-center">Register</button>
